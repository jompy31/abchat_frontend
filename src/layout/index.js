        ...
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          >
            ...
            {greaterThenSm && user?.profile === "admin" && user?.company?.dueDate ? (
              <>
                Pura vida <b>{user.name}</b>, Bienvenido al CRM de <b>{user?.company?.name}</b>! (Activo hasta{dateToClient(user?.company?.dueDate)})
              </>
            ) : (
              <>
                Pura vida <b>{user.name}</b>, Bienvenido al CRM de <b>{user?.company?.name}</b>!
              </>
            )}
          </Typography>

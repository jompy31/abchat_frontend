...
function _renderStepContent(step, setFieldValue, setActiveStep, values ) {
  ...
  Factura: ${invoiceId}
  Dirección de facturación: ${values.address2}, ${values.city}, ${values.state}, ${values.zipcode}, ${values.country}
`;

// El número de teléfono al que se enviará el mensaje (60708161)
const phoneNumber = '60708161';
const whatsappLink = `https://api.whatsapp.com/send?phone=506${phoneNumber}&text=${encodeURIComponent(finalMessage)}`;

    // Abre el enlace de WhatsApp para enviar el mensaje
